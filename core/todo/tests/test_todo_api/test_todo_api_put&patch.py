...
class TestTodoApiPutAndPatch:
    ...
    def test_put_todo_with_valid_payload_common_user(
        self, api_client, common_user, todo
    ):
    ...
    def test_put_todo_with_invalid_payload_common_user(
        self, api_client, common_user, todo
    ):
        api_client.force_authenticate(user=common_user)
        url = reverse("todo:api-v1:todo-detail", kwargs={"pk": todo.id})
    ...
    def test_patch_todo_with_valid_payload_common_user(
        self, api_client, common_user, todo
    ):
        api_client.force_authenticate(user=common_user)
        url = reverse("todo:api-v1:todo-detail", kwargs={"pk": todo.id})
    ...
    def test_patch_todo_with_invalid_payload_common_user(
        self, api_client, common_user, todo
    ):
        api_client.force_authenticate(user=common_user)
        url = reverse("todo:api-v1:todo-detail", kwargs={"pk": todo.id})
    ...
    def test_patch_and_put_todo_with_invalid_payload_anonymous_user(
        self, api_client, todo
    ):
        url = reverse("todo:api-v1:todo-detail", kwargs={"pk": todo.id})
    ...
    def test_patch_and_put_todo_with_valid_payload_anonymous_user(
        self, api_client, todo
    ):
        url = reverse("todo:api-v1:todo-detail", kwargs={"pk": todo.id})
